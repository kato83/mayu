...
func (m *mockStore) GetVulnSummariesByIDs(ctx context.Context, ids []string) (map[string]*store.VulnSummaryRow, error) {
	return nil, nil
}
...
func (m *mockStore) GetEOLReport(ctx context.Context, days int) ([]store.EOLReportProduct, []store.EOLUpcomingProduct, error) {
	return []store.EOLReportProduct{}, []store.EOLUpcomingProduct{}, nil
}
