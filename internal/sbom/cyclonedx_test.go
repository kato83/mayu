...
<bom xmlns="http://cyclonedx.org/schema/bom/1.6" version="1">
  <components>
    <component type="library" bom-ref="pkg:npm/%40angular/core@22.0.7">
      <group>@angular</group>
      <name>core</name>
      <version>22.0.7</version>
      <scope>required</scope>
      <purl>pkg:npm/%40angular/core@22.0.7</purl>
    </component>
    <component type="library" bom-ref="pkg:npm/%40angular/build@22.0.7">
      <group>@angular</group>
      <name>build</name>
      <version>22.0.7</version>
      <scope>excluded</scope>
      <purl>pkg:npm/%40angular/build@22.0.7</purl>
      <properties>
...
func TestParseCycloneDXXML_DevDetection(t *testing.T) {
	tests := []struct {
		name    string
		xml     string
		wantDev bool
...
func TestParseCycloneDXXML_SkipNoPurl(t *testing.T) {
	data := []byte(`<?xml version="1.0" encoding="UTF-8"?>
<bom xmlns="http://cyclonedx.org/schema/bom/1.6">
  <components>
    <component type="library">
      <name>has-purl</name>
      <version>1.0.0</version>
      <purl>pkg:npm/has-purl@1.0.0</purl>
    </component>
    <component type="library">
      <name>no-purl</name>
...
func TestParseCycloneDXXML_EmptyComponents(t *testing.T) {
	data := []byte(`<?xml version="1.0" encoding="UTF-8"?>
<bom xmlns="http://cyclonedx.org/schema/bom/1.6">
  <components>
  </components>
	...
	if len(sbom.Components) != 0 {
		t.Errorf("len(Components) = %d, want 0", len(sbom.Components))
	}
}

func TestParseCycloneDXYAML(t *testing.T) {
...
func TestParseCycloneDXYAML_DevDetection(t *testing.T) {
	tests := []struct {
		name    string
		yaml    string
		wantDev bool
...
func TestParseCycloneDXYAML_SkipNoPurl(t *testing.T) {
	data := []byte(`bomFormat: CycloneDX
specVersion: "1.6"
components:
  - type: library
...
func TestParseCycloneDXYAML_EmptyComponents(t *testing.T) {
	data := []byte(`bomFormat: CycloneDX
specVersion: "1.6"
components: []
`)
