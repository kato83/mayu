  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/epss-trending/epss-trending.component').then((m) => m.EpssTrendingComponent),
      },
      {
        path: 'ingest/jobs',
        title: $localize`:@@route.title.ingestJobs:Ingest Jobs`,
        loadComponent: () => import('./pages/ingest-jobs/ingest-jobs.component').then((m) => m.IngestJobsComponent),
      },
      {
        path: 'ingest',
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/webhooks/webhook-deliveries.component').then((m) => m.WebhookDeliveriesComponent),
      },
      {
        path: 'sbom',
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/sbom/sbom-project-detail.component').then((m) => m.SbomProjectDetailComponent),
      },
      {
        path: 'sbom/:projectId/scans/:scanId',
        title: $localize`:@@route.title.sbomScan:Scan Result`,
        loadComponent: () => import('./pages/sbom/sbom-scan-detail.component').then((m) => m.SbomScanDetailComponent),
      },
      {
        path: 'watchlists',
