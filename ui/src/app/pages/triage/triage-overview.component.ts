  ...
  template: `
    @if (loading()) {
      ...
      <p class="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1 mb-4">
        ...
        <span i18n="@@triageOverview.defaultProfileNote">Overview counts are computed using the default profile. Custom profile settings are not reflected here.</span>
      </p>
