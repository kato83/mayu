                      ...
                      <td colspan="8" class="p-0">
                        <div class="border-t border-indigo-200 dark:border-indigo-800 bg-indigo-50/50 dark:bg-indigo-900/10 p-4 space-y-4">
                          @if (detailLoading()) {
                            ...
                            <!-- Close button -->
                            <div class="flex items-center justify-between">
                              <h2 class="text-sm font-semibold text-slate-900 dark:text-slate-100" i18n="@@ingestJobs.detail.title">
                                Job Detail
                              </h2>
                              <button
                            ...
                            <!-- Command args -->
                            <div>
                              <h3 class="text-xs font-medium text-slate-600 dark:text-slate-400 mb-1" i18n="@@ingestJobs.detail.commandArgs">Command Arguments</h3>
                            ...
                            @if (jobDetail()!.error_message) {
                              <div>
                                <h3 class="text-xs font-medium text-red-600 dark:text-red-400 mb-1" i18n="@@ingestJobs.detail.error">Error</h3>
                            ...
                            @if (jobDetail()!.failures && jobDetail()!.failures.length > 0) {
                              <div>
                                <h3 class="text-xs font-medium text-slate-600 dark:text-slate-400 mb-2" i18n="@@ingestJobs.detail.failures">
